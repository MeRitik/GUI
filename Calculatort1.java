...
//        try {
//        	myFont = Font.createFont(Font.TRUETYPE_FONT, new File("Digital7-1e1Z.ttf")).deriveFont(36f);
//        	GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
//        	ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new File("Digital7-1e1Z.ttf")));
...
//        }
        ...
        p.setBackground(new Color(130, 120, 120));
        ...
        box.setText("");
        box.setBackground(new Color(233, 233, 233));
        ...
        b0.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (box.getText().equals(""))
                    box.setText("");
                else if(box.getText().charAt(box.getText().length()-1) == '\u221A')
                	return;
                else
